"""
SVD Implementation using Surprise Library for Movie Recommendation System

This module implements matrix factorization using Surprise's SVD algorithm
...
class SurpriseSVD:
    ...
    Attributes:
        model (SVD): Surprise SVD model instance
        trainset: Surprise trainset object
        testset: Surprise testset object
        movie_info_dict (Dict): Dictionary mapping movieId to movie info
        n_factors (int): Number of latent factors
        n_epochs (int): Number of training epochs
        lr_all (float): Learning rate
        reg_all (float): Regularization term
        biased (bool): Whether to use bias terms
    """
    ...
    def __init__(
        ...
        """
        Initialize Surprise SVD recommender.
        ...
        Args:
            ...
            biased: Whether to use bias terms
    ...
    def fit(self):
        ...
        Loads data, splits into train/test, trains model, and loads movie metadata.
        """
        print("Loading data...")
    ...
    def save_model(self):
        """Save model to disk."""
        path = f"{model_settings.model_path}/{model_settings.model_name_svd}.pkl"
